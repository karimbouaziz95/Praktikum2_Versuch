...
class LazyListe
{
   public:
      ...
      const_iterator end() const {return p_ListeObjekte.begin();}//...s.o.
      iterator begin() {return p_ListeObjekte.begin();}
      iterator end() {return p_ListeObjekte.end();}      //...s.o.
	  bool empty() const {if(p_ListeObjekte.begin()==p_ListeObjekte.end()){return true;} return false; }//...
   ...
   private:
      list<T>				p_ListeObjekte; // 1.Liste
      list<LazyAktion<T>*>	p_ListeAktionen; // 2.Liste
      bool					bChanged;
};
