...
void PKW::vAbfertigung()
{
	...
	if (p_dTankinhalt > 0)
	{
		double dGesamtStreckeTemp = p_dGesamtStrecke; // Streckenzähler zwischenspeichern
		...
		if (p_dTankinhalt < 0) p_dTankinhalt = 0; // keine negativen Füllstände zulassen
	}
}
...
double PKW::dGeschwindigkeit() const
{
	...
	{
		return p_dMaxGeschwindigkeit; // Fallback für Aufgabenblock 1
	}
}
