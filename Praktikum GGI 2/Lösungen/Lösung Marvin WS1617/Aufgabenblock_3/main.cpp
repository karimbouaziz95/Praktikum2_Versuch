...
// Vergleichsfunktion für zwei double-Werte mit Fehlertoleranz.
...
void vAufgabe_2()
{
	...
	for (auto it = vecFahrzeuge.begin(); it != vecFahrzeuge.end(); it++)
	{
		delete *it; // Dynamische Objekte löschen
	}
}
...
void vAufgabe_8()
{
	...
	Kr1.vVerbinde(&Kr2, "W12", "W21", 40, Weg::Innerorts, true);		// Straße 1
	Kr2.vVerbinde(&Kr3, "W23a", "W32a", 115, Weg::Autobahn, false);		// Straße 2
	Kr2.vVerbinde(&Kr3, "W23b", "W32b", 40, Weg::Innerorts, true);		// Straße 3
	Kr2.vVerbinde(&Kr4, "W24", "W42", 55, Weg::Innerorts, true);		// Straße 4
	Kr3.vVerbinde(&Kr4, "W34", "W43", 85, Weg::Autobahn, false);		// Straße 5
	Kr4.vVerbinde(&Kr4, "W44a", "W44b", 130, Weg::Landstrasse, false);	// Straße 6
...
void vAufgabe_9a()
{
	...
	if (!fsInput)
	{
		cerr << "VO.dat konnte nicht geöffnet werden." << endl;
		exit(1);
	}
...
void vAufgabe_9b()
{
	...
	if (!fsInput)
	{
		cerr << "Simu.dat konnte nicht geöffnet werden." << endl;
		exit(1);
	}
...
void vAufgabe_9c()
{
	...
	if (!fsInput)
	{
		cerr << "SimuDisplay.dat konnte nicht geöffnet werden." << endl;
		exit(1);
	}
...
// Typedef für Funktionspointer auf eine Aufgabe
...
int main(void)
{
	...
	srand(42); // Konstanter Seed für "zufällige" Verhaltensmuster

	string sChoose = "";
	do
	{
		cout << "Praktikum Informatik II (WS2016) - Strassenverkehr Block 3" << endl;
