...
bool PKW::bKannFahren()
{
	//Kann fahren und hat genug Tankinhalt.
	return Fahrzeug::bKannFahren() && p_dTankinhalt > 0;
...
istream & PKW::istreamEingabe(istream & input)
{
	...
	input >> p_dVerbrauch >> p_dTankvolumen;
	p_dTankinhalt = 0.5 * p_dTankvolumen; //Tanken
	return input;
}
