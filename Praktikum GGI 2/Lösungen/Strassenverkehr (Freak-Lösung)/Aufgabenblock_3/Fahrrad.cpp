...
// Eingabe:
istream& Fahrrad::istreamEingabe(istream& istreamStream)
{
...
// Eingabeoperator:
istream& operator>>(istream& istreamStream, Fahrrad& fFahrrad)
{
    return fFahrrad.istreamEingabe(istreamStream);
}
